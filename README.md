...
XCutors is a collection of Roblox executors for running Lua scripts in games.

### Which executors are included?

Volt, Synapse Z, Potassium, Wave, and a universal loader.

### Is it safe to use?

XCutors is designed for customization and runs locally on your Windows PC.

### How do I install it?

Download the package, extract files, and run the loader executable.

### What are the system requirements?

Windows 10 or later, with sufficient RAM for Roblox.

### Can I add other executors?

The universal loader supports multiple executors; check documentation for compatibility.

### Are updates provided?

Yes, XCutors includes auto-update features to keep tools current.

### Do I need to pay for anything?

XCutors is open-source and free to use; all executors have their own terms.
